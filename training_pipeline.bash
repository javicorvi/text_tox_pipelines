...
sudo docker run --rm  -u $UID -v /home/jcorvi/text_tox_test/pubmed/classificator:/app/data pubmed_random_retrieval python pubmed_random_retrieval.py -p /app/data/random_retrieval.properties

# Execute Download Gold Answer Retrieval Container
sudo docker run --rm  -u $UID -v /home/jcorvi/text_tox_test/pubmed/classificator:/app/data pubmed_goldsearch_retrieval python pubmed_goldsearch_retrieval.py -p /app/data/gold_retrieval.properties

# Generate Training Data Set
sudo docker run --rm  -u $UID -v /home/jcorvi/text_tox_test/pubmed/classificator:/app/data generate_training_dataset python generate_training_dataset.py -p /app/data/generate_training_dataset.properties
